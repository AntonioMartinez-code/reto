...
public class lineaBilb_Don extends javax.swing.JFrame {

    
    public lineaBilb_Don() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SELECCIONAR ORIGEN/DESTINO: LINEA BILBAO - DONOSTIA");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lineaBilb_Don().setVisible(true);
            }
        });
    }

...
public class lineaBilb_Ger extends javax.swing.JFrame {

    
    public lineaBilb_Ger() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SELECCIONAR ORIGEN/DESTINO: LINEA BILBAO - GERNIKA");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lineaBilb_Ger().setVisible(true);
            }
        });
    }
